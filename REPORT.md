...
n_episodes = 5000                # Max nb of episodes
...
Both Neural Networks use the Adam optimizer with a learning rate of 1e-4 (actors) and 1e-3 (critics) are trained using a batch size of 250.
...
**These results meets the project's expectation as the agent is able to receive an average reward (over 100 episodes) of at least +0.5 in 1306 episodes** 
